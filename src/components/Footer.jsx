      ...
      <div className="container footer__inner">
        ...
        <div className="footer__contact-section">
          ...
          <div className="footer__contact-grid">
            <a href="mailto:ryanputra1478@gmail.com" className="footer__contact-card">
              ...
              <div>
                ...
                <span className="footer__contact-value">ryanputra1478@gmail.com</span>
              </div>
            </a>

            <a href="https://wa.me/6289510659429" target="_blank" rel="noopener noreferrer" className="footer__contact-card">
              <div className="footer__contact-icon footer__contact-icon--wa">
              ...
              <div>
                ...
                <span className="footer__contact-value">+62 895-1065-9429</span>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__social-links">
            ...
            <a href="https://github.com/RyanPutra1478" target="_blank" rel="noopener noreferrer" aria-label="GitHub" title="GitHub">
            ...
            <a href="https://www.instagram.com/ryan_putra_1478/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Instagram">
            ...
            <a href="https://www.youtube.com/@rytube1478" target="_blank" rel="noopener noreferrer" aria-label="YouTube" title="YouTube">
        ...
        <p className="footer__copy">
          &copy; {new Date().getFullYear()} Ryan Saputra. All rights reserved.
        </p>
      </div>
    </footer>
  );
